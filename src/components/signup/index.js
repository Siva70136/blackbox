...
const Login = (props) => {
    ...
    return (
        <div className="main-container " id="login_page">
            {presentUser ? <Home manager={manager} emp={emp} /> :
                <div className="app-container">
                    <div>
                        <form id="addUserForm" className="form" autoComplete='off'>
                            <h3 className="textHead">Sign in</h3>
                            <p className='left'>User Id</p>
                            <input type="text" name="" id="name" value={email} className="form-control input" placeholder="Email OR Phone" onChange={e => setEmail(e.target.value)} required />
                        ...
                        <div className="icons">
                            <h1 className="heading mt-2">Login with social media</h1>
